...
static const _FloatStamped_type_support_symbol_names_t _FloatStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qlearn_interfaces, msg, FloatStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qlearn_interfaces, msg, FloatStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qlearn_interfaces, msg, FloatStamped)() {
  return &::qlearn_interfaces::msg::rosidl_typesupport_c::FloatStamped_message_type_support_handle;
}
