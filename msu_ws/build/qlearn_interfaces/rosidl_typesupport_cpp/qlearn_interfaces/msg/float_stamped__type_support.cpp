...
static const _FloatStamped_type_support_symbol_names_t _FloatStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qlearn_interfaces, msg, FloatStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qlearn_interfaces, msg, FloatStamped)),
  }
};
...
{
  return &::qlearn_interfaces::msg::rosidl_typesupport_cpp::FloatStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qlearn_interfaces, msg, FloatStamped)() {
  return get_message_type_support_handle<qlearn_interfaces::msg::FloatStamped>();
}
