...
#include "qlearn_interfaces/msg/detail/float_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qlearn_interfaces::msg::FloatStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qlearn_interfaces::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<qlearn_interfaces::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  return &qlearn_interfaces::msg::typesupport_fastrtps_cpp::_FloatStamped__handle;
}
