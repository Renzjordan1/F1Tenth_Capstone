...
bool pid_msgs__msg__pid_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pid_msgs.msg._pid_input.PIDInput", full_classname_dest, 32) == 0);
  }
  pid_msgs__msg__PIDInput * ros_message = _ros_message;
  {  // pid_vel
...
PyObject * pid_msgs__msg__pid_input__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pid_msgs.msg._pid_input");
