...
{
  new (message_memory) pid_msgs::msg::PIDInput(_init);
}

void PIDInput_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pid_msgs::msg::PIDInput *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PIDInput_message_member_array[2] = {
  {
    ...
    offsetof(pid_msgs::msg::PIDInput, pid_vel),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pid_msgs::msg::PIDInput, pid_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PIDInput_message_members = {
  "pid_msgs::msg",  // message namespace
  "PIDInput",  // message name
  2,  // number of fields
  sizeof(pid_msgs::msg::PIDInput),
...
{
  return &::pid_msgs::msg::rosidl_typesupport_introspection_cpp::PIDInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pid_msgs, msg, PIDInput)() {
  return &::pid_msgs::msg::rosidl_typesupport_introspection_cpp::PIDInput_message_type_support_handle;
}
