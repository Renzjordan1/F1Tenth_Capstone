...
qlearn_interfaces__msg__IntStamped__init(qlearn_interfaces__msg__IntStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    qlearn_interfaces__msg__IntStamped__fini(msg);
    return false;
  }
  // data
  return true;
...
qlearn_interfaces__msg__IntStamped__create()
{
  ...
  qlearn_interfaces__msg__IntStamped * msg = (qlearn_interfaces__msg__IntStamped *)allocator.allocate(sizeof(qlearn_interfaces__msg__IntStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(qlearn_interfaces__msg__IntStamped));
  bool success = qlearn_interfaces__msg__IntStamped__init(msg);
  if (!success) {
...
qlearn_interfaces__msg__IntStamped__Sequence__init(qlearn_interfaces__msg__IntStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qlearn_interfaces__msg__IntStamped * data = NULL;

  if (size) {
    data = (qlearn_interfaces__msg__IntStamped *)allocator.zero_allocate(size, sizeof(qlearn_interfaces__msg__IntStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = qlearn_interfaces__msg__IntStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        qlearn_interfaces__msg__IntStamped__fini(&data[i - 1]);
      }
...
qlearn_interfaces__msg__IntStamped__Sequence__fini(qlearn_interfaces__msg__IntStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      qlearn_interfaces__msg__IntStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  qlearn_interfaces__msg__IntStamped__Sequence * array = (qlearn_interfaces__msg__IntStamped__Sequence *)allocator.allocate(sizeof(qlearn_interfaces__msg__IntStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = qlearn_interfaces__msg__IntStamped__Sequence__init(array, size);
  if (!success) {
...
qlearn_interfaces__msg__IntStamped__Sequence__destroy(qlearn_interfaces__msg__IntStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    qlearn_interfaces__msg__IntStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
qlearn_interfaces__msg__IntStamped__Sequence__are_equal(const qlearn_interfaces__msg__IntStamped__Sequence * lhs, const qlearn_interfaces__msg__IntStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!qlearn_interfaces__msg__IntStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  qlearn_interfaces__msg__IntStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(qlearn_interfaces__msg__IntStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    qlearn_interfaces__msg__IntStamped * data =
      (qlearn_interfaces__msg__IntStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!qlearn_interfaces__msg__IntStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          qlearn_interfaces__msg__IntStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!qlearn_interfaces__msg__IntStamped__copy(
