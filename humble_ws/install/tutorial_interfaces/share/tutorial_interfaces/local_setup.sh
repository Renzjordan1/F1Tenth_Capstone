...
<<<<<<< HEAD
<<<<<<< HEAD
: ${AMENT_CURRENT_PREFIX:="/home/rstole01/Documents/CapstoneGit/humble_ws/install/tutorial_interfaces"}
=======
: ${AMENT_CURRENT_PREFIX:="/home/rstole01/Documents/CSE-596/humble_ws/install/tutorial_interfaces"}
